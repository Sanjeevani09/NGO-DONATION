...
<body>
        ...
        <nav class="navbar navbar-expand-lg my-navbar">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="./viewvolunteer.php">View Volunteer</a>
                    </li>
                    <li class="nav-item">
    ...
    <section>
        <div class="container py-4 my-4 bg-light" style="box-shadow: 2px 2px 2px 2px #777;">
            ...
            ?>
                <h2 style="text-align : center; font-weight: bold;">Internship Appliers :
                    <hr class="internship-green-hr">
                </h2>
                <table class="table table-hover">
                    <thead class="thead-light">
                        <?php echo "<tr><th> Name</th><th>Email</th><th>Phone</th><th>Field</th><th>Message</th><th>Resume</th><th></th></tr>"; ?></thread>
                    <?php while ($row = mysqli_fetch_assoc($result)) {
                        $vid = $row['id'];
                        echo "<tr><td>" . $row["name"] . "</td><td>" . $row["email"] . "</td><td>" . $row["phone"] . "</td><td>" . $row["post"] . "</td><td>" . $row["message"] . "</td><td><a href='viewresume.php?id=$vid' target='_blank'><button class='btn btn-info'>Resume</button></a></td><td><a href='sendemail.php?id=$vid' target='_blank'><button class='btn btn-primary'>Reply</button></a></td></tr>";
                    }
                    echo "</table>";
                } else {
