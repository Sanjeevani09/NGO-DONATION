      ...
      <div class="row ">
        ...
        <div class="col internship" data-aos="zoom-in-up" data-aos-easing="ease-in-sine" data-aos-delay="200">
          ...
          <form action="#" name='addevents' id="addevents" method="post" enctype="multipart/form-data">
            ...
            <a href="managefeatureevent.php"><button type="button" class="btn btn-outline-success  mt-2 " name="back">Back</button></a>
          </form>
        </div>
        <div class="col"></div>
      </div>
...
if (isset($_POST['submit'])) {
  ...
  $folder = "images/feature_event_images/" . $filename;
  ...
  $sql = "INSERT INTO featureevent(name, date, description, details, image) values ('$name', '$date', '$description', '$details', '$folder')";
