...
<body>
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="nav-link active" href="managefeatureevent.php">Featured Event</a>
  ...
  <section>
    <div class="container py-4 my-4 bg-light" style="box-shadow: 2px 2px 2px 2px #777; ">
      ...
      ?>
        <h2 style="text-align : center; font-weight: bold;">Featured Event :
        ...
        <table class="table table-hover ">
          <thead class="thead-light">
            ...
            <?php while ($row = mysqli_fetch_assoc($result)) {
              ...
              echo "<tr><td>" . $row["name"] . "</td><td>" . $date . "</td><td>" . "<img src='" . $row['image'] . "'height='100px'; width='200px';>" . "</td><td>" . $shortenedValue1 . "</td><td><a href='editfeatureevent.php?id=$feid'><button class='btn btn-primary'>Edit</button></a></td><td><a href='delete.php?id=$feid'><button class='btn btn-danger'>Delete</button></a></td></tr>";
            }
            echo "</table>";
          } else { ?>
            <div class="container" style="text-align:center">
            ...
            echo "<a href='addfeatureevent.php'><button class='btn btn-primary'>Add Events</button></a>";
          }
          mysqli_close($conn);
            ?>
            </div>
